...
DEFINE_VECTOR_TYPE(drgn_type_member_function_vector, struct drgn_type_member_function)
DEFINE_VECTOR_TYPE(drgn_typep_vector, struct drgn_type *) // TODO move back to old location XXX
